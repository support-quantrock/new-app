      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
        <LinearGradient
          ...
          <View style={styles.profitRow}>
            ...
            <Text style={styles.profitValue}>+$500.00 (+5.00%)</Text>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalScrollView}>
              ...
              <View style={styles.riskSliderContainer}>
                <View style={styles.newRiskSliderWrapper}>
                  <View
                    style={styles.newRiskSliderTrack}
                    ...
                    <LinearGradient
                      ...
                      style={styles.newRiskSliderGradient}>
                      <View style={[styles.newRiskSliderThumb, { left: `${riskPercentage}%` }]} />
                    </LinearGradient>
                  </View>
                  <View style={styles.newRiskSliderLabels}>
                    <Text style={styles.newRiskSliderLabelText}>Low Risk (0%)</Text>
                    <Text style={styles.newRiskSliderLabelText}>High Risk (100%)</Text>
                  </View>
                </View>
              </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.datePickerModal}>
            ...
            <View style={styles.datePickerContent}>
              ...
              <View style={styles.dateQuickSelects}>
                ...
                <View style={styles.quickSelectButtons}>
                  ...
                  <TouchableOpacity style={styles.quickSelectButton}>
                    <Text style={styles.quickSelectButtonText}>Year to Date</Text>
                  </TouchableOpacity>
                </View>
              </View>

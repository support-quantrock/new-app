...
export default function QChat() {
  ...
  const challengeCards = [
    ...
    },
    {
      ...
      subtitle: 'Test your trading expertise through progressive challenges. Develop advanced strategies, master risk management, and compete with traders worldwide to unlock exclusive rewards.',
      badge: 'Expert',
      badgeColor: '#8b5cf6',
      avatarIcon: Medal,
      gradientColors: ['#4c1d95', '#5b21b6'],
      info: [
        { icon: Trophy, label: 'Levels:', value: '5 Stages' },
        { icon: Award, label: 'Win Rate:', value: '65%+' },
        { icon: Target, label: 'Challenges:', value: '50+' },
        { icon: TrendingUp, label: 'Rewards:', value: 'Exclusive' },
      ],
    },
  ];
  ...
  const renderChallengeCard = (card: any) => {
    ...
    const isExpanded = card.id === 1 ? expandedCard1 : expandedCard4;
    const setExpanded = card.id === 1 ? setExpandedCard1 : setExpandedCard4;
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Quantrock Investment Championship</Text>
        </View>
                        ...
                        <View style={styles.detailedAccountRow}>
                          ...
                          <View style={styles.portfolioValueContainer}>
                            <View style={styles.portfolioFlexRow}>
                              ...
                              <View style={styles.arrowWithDaysAbove}>
                  ...
                  <View style={styles.expandedList}>
                    {tradingLeaderboardData.slice(3).map((item) => (
                      <View key={item.rank} style={styles.detailedLeaderboardCard}>
                        ...
                        <View style={styles.detailedAccountRow}>
                          <View style={styles.portfolioLabelWithDays}>
                            <Text style={styles.detailedAccountLabel}>Portfolio value:</Text>
                            <Text style={styles.daysText}>90 days</Text>
                          </View>
                          <View style={styles.portfolioValueContainer}>
